...
This repository is **index-first**. Each skill has its own independent
repository as the source of truth; the local `skills/` directory is only an
install/browsing mirror.
